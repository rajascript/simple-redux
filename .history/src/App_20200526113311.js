...
function mapDispatchToProps(saareActions) {
  return saareActions;
}

const propsSeAttatchKrnewlafunc = connect(
  mapGloabalStateToProps,
  mapDispatchToProps
); //returning function that adds props to a component
